...
/**
 * @extends AbstractCrudController<TextNoticeTemplateMessage>
 */
#[AdminCrud(routePath: '/wechat-work-push/text-notice-template-message', routeName: 'wechat_work_push_text_notice_template_message')]
final class TextNoticeTemplateMessageCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return TextNoticeTemplateMessage::class;
    }
    ...
    {
        return $crud
            ->setEntityLabelInSingular('文本通知模板消息')
            ->setEntityLabelInPlural('文本通知模板消息')
