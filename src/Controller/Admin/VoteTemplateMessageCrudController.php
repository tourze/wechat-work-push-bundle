...
/**
 * @extends AbstractCrudController<VoteTemplateMessage>
 */
#[AdminCrud(routePath: '/wechat-work-push/vote-template-message', routeName: 'wechat_work_push_vote_template_message')]
final class VoteTemplateMessageCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return VoteTemplateMessage::class;
    }
    ...
    {
        return $crud
            ->setEntityLabelInSingular('投票模板消息')
            ->setEntityLabelInPlural('投票模板消息')
