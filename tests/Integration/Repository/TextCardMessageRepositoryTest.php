...
class TextCardMessageRepositoryTest extends TestCase
{
    ...
    {
        $repository = new TextCardMessageRepository($this->registry);
        $this->assertInstanceOf(TextCardMessageRepository::class, $repository);
    }
}