...
class MarkdownMessageRepositoryTest extends TestCase
{
    ...
    {
        $repository = new MarkdownMessageRepository($this->registry);
        $this->assertInstanceOf(MarkdownMessageRepository::class, $repository);
    }
}