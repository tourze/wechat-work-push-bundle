...
class MultipleTemplateMessageRepositoryTest extends TestCase
{
    ...
    {
        $repository = new MultipleTemplateMessageRepository($this->registry);
        $this->assertInstanceOf(MultipleTemplateMessageRepository::class, $repository);
    }
}