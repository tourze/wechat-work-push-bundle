...
class NewsMessageRepositoryTest extends TestCase
{
    ...
    {
        $repository = new NewsMessageRepository($this->registry);
        $this->assertInstanceOf(NewsMessageRepository::class, $repository);
    }
}