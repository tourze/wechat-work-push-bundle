...
class MpnewsMessageRepositoryTest extends TestCase
{
    ...
    {
        $repository = new MpnewsMessageRepository($this->registry);
        $this->assertInstanceOf(MpnewsMessageRepository::class, $repository);
    }
}