...
class TextNoticeTemplateMessageRepositoryTest extends TestCase
{
    ...
    {
        $repository = new TextNoticeTemplateMessageRepository($this->registry);
        $this->assertInstanceOf(TextNoticeTemplateMessageRepository::class, $repository);
    }
}