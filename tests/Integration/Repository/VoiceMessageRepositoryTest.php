...
class VoiceMessageRepositoryTest extends TestCase
{
    ...
    {
        $repository = new VoiceMessageRepository($this->registry);
        $this->assertInstanceOf(VoiceMessageRepository::class, $repository);
    }
}