...
class NewsTemplateMessageRepositoryTest extends TestCase
{
    ...
    {
        $repository = new NewsTemplateMessageRepository($this->registry);
        $this->assertInstanceOf(NewsTemplateMessageRepository::class, $repository);
    }
}