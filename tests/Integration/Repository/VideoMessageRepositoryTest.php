...
class VideoMessageRepositoryTest extends TestCase
{
    ...
    {
        $repository = new VideoMessageRepository($this->registry);
        $this->assertInstanceOf(VideoMessageRepository::class, $repository);
    }
}